    ...
    <div class="my-2 bg-white m-auto rounded p-5">
        ...
        <div class="grid grid-cols-3 gap-4">
            ...
            <div class="flex justify-end my-2 gap-2" x-data="buttons">
                <button wire:click="backTo()" onclick="history.back()" class="btn-danger">
                    Regresar
                </button>
                <button wire:click="saveEtapa()" @click="toggleClose" class="btn-apply">Guardar</button>||
                <button x-show="open" wire:click="newEtapa()" @click="toggle" class="btn-success">Agregar</button>  
            </div>
        </div>
